...
public class TrainableNameFinderTest extends AbstractTrainableProcessorTest<TrainableNameFinder> {

    public TrainableNameFinderTest() {
        super(TrainableNameFinder.class);
    }
