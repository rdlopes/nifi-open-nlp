...
@WritesAttributes({@WritesAttribute(attribute = ATTRIBUTE_NLP_ERROR,
                   ...
                   @WritesAttribute(attribute = ATTRIBUTE_TAGPOS_TAG_COUNT,
                                    description = "The number of tags found in the flow file content."),
                   @WritesAttribute(attribute = ATTRIBUTE_TAGPOS_TAG_LIST,
...
public class TagPartOfSpeech extends AbstractNlpProcessor<POSModel> {
    ...
    public static final String ATTRIBUTE_TAGPOS_TAG_COUNT = "nlp.tagpos.tag.count";

    public static final String ATTRIBUTE_TAGPOS_TAG_LIST = "nlp.tagpos.tag.list";

    public static final String ATTRIBUTE_TAGPOS_TAG_LIST_DESCRIPTION = "The list of tags found by the TagPOS tool, as a JSON list.";
