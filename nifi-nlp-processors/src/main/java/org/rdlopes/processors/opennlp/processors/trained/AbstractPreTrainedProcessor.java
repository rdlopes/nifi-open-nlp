...
public abstract class AbstractPreTrainedProcessor<T, M extends BaseModel> extends AbstractNLPProcessor<T, M> {
    @Getter
    ...
    public AbstractPreTrainedProcessor(NLPToolWrapper<T, M> toolWrapper) {
        super(toolWrapper);
    }
