...
@WritesAttributes({@WritesAttribute(attribute = ATTRIBUTE_NLP_ERROR,
                   ...
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_COUNT,
                                    description = "Lemmas list size."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_LIST,
                                    description = "Lemmas list as evaluated from flow file content."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_COUNT,
                                    description = "Lemmas predicted count"),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_LIST,
                                    description = "List of predicted lemmas."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_SES_COUNT,
                                    description = "SES prediction list size."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_SES_LIST,
                                    description = "SES prediction list"),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_LEMMA_COUNT,
                                    description = "Top K lemmas list size."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_LEMMA_LIST,
                                    description = "Top K lemmas list."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_SEQUENCE_COUNT,
                                    description = "Top K sequence list size."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_SEQUENCE_LIST,
                                    description = "Top K sequence list, as a JSON list of sequence objects."),
                   @WritesAttribute(attribute = ATTRIBUTE_LEMMATIZE_LEMMA_PROBABILITIES,
                                    description = "Lemmas probabilities, as a JSON list of doubles.")})
@EqualsAndHashCode(callSuper = true)
public class Lemmatize extends AbstractNlpProcessor<LemmatizerModel> {

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_COUNT = "nlp.lemmatize.lemma.count";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_LIST = "nlp.lemmatize.lemma.list";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_COUNT = "nlp.lemmatize.lemma.predicted.count";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_LIST = "nlp.lemmatize.lemma.predicted.list";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_SES_COUNT = "nlp.lemmatize.lemma.predicted.ses.count";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_PREDICTED_SES_LIST = "nlp.lemmatize.lemma.predicted.ses.list";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_PROBABILITIES = "nlp.lemmatize.lemma.probabilities";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_LEMMA_COUNT = "nlp.lemmatize.lemma.topk.lemma.count";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_LEMMA_LIST = "nlp.lemmatize.lemma.topk.lemma.list";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_SEQUENCE_COUNT = "nlp.lemmatize.lemma.topk.sequence.count";

    public static final String ATTRIBUTE_LEMMATIZE_LEMMA_TOPK_SEQUENCE_LIST = "nlp.lemmatize.lemma.topk.sequence.list";

    public static final PropertyDescriptor PROPERTY_LEMMAS_SEARCH_COUNT = new PropertyDescriptor.Builder()
    ...
    public static final PropertyDescriptor PROPERTY_TOPK_MINIMUM_SCORE = new PropertyDescriptor.Builder()
