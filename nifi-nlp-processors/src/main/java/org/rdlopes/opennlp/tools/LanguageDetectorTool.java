...
public class LanguageDetectorTool extends NLPTool<LanguageDetectorModel> {
    ...
    protected void evaluate(ProcessContext processContext, InputStream content, Charset charset, Map<String, String> attributes, LanguageDetectorModel model, Map<String, String> evaluation)
        ...
        NLPAttribute.set(NLPAttribute.LANGUAGE_DETECTOR_LANGUAGES_LIST_KEY, evaluation, probableLanguageList);
        NLPAttribute.set(NLPAttribute.LANGUAGE_DETECTOR_LANGUAGES_BEST_KEY, evaluation, predictedLanguage);
        NLPAttribute.set(NLPAttribute.LANGUAGE_DETECTOR_SUPPORTED_LIST_KEY, evaluation, supportedLanguages);
    }
